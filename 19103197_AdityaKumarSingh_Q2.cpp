...
public:
    ...
    virtual int tellMarks(int sub_id) = 0;          //utility func for query 1
    virtual bool dbar(int sub_id) = 0;              //utility func for query 2
    //utility function for query 3:
    int getCG() {
        return CGPA;
    }
};
...
public:
    ...
    //fun to return the marks of a subject:
    //utility function for query 1:
    ...
    //fun to tell whether the student is debarred in a subject or not
    //utility function for query 2:
...
int main() {
    ...
    student *st[6];
    for (i = 0; i < 6; i++) st[i] = new UGStudent;
    ...
    while (1) {
        ...
        switch(choice) {
            ...
            case 3: query3(st, 6);
                    break;
            case 4: listSubjects(s, 8);
                    break;
            case 5: listStudents(st, 6);
                    break;
            case 6: exit(0);
